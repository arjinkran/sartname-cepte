...
import { DOKUMANLAR, KATEGORILER, KURUMLAR, type Kurum } from '../../src/data/sartnameler';
import { ara, filtrele } from '../../src/logic/arama';
...
export default function SartnameArama() {
