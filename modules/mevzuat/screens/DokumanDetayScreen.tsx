...
import { DOKUMANLAR, KATEGORILER, DURUM_ETIKETLERI } from '../data/sartnameler';
import { KurumRozeti, DurumRozeti } from '../components/DokumanSatiri';
...
export default function DokumanDetayScreen() {
