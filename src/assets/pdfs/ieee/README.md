...
Bu klasör, IEEE belgelerinin gerçek PDF dosyaları için ayrılmıştır.

**Şu an boş.** Kütüphanedeki hiçbir IEEE belgesinde henüz gerçek bir
...
2. `src/data/library/ieee/documents.ts`'te ilgili belgenin şu alanlarını doldurun:
   - `localAsset: 'ieee/<dosya-adi>.pdf'`
   - `pdfAvailable: true`
