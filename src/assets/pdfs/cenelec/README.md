...
Bu klasör, CENELEC belgelerinin gerçek PDF dosyaları için ayrılmıştır.

**Şu an boş.** Kütüphanedeki hiçbir CENELEC belgesinde henüz gerçek bir
...
2. `src/data/library/cenelec/documents.ts`'te ilgili belgenin şu alanlarını doldurun:
   - `localAsset: 'cenelec/<dosya-adi>.pdf'`
   - `pdfAvailable: true`
