...
Bu klasör, Diğer belgelerinin gerçek PDF dosyaları için ayrılmıştır.

**Şu an boş.** Kütüphanedeki hiçbir Diğer belgesinde henüz gerçek bir
...
2. `src/data/library/other/documents.ts`'te ilgili belgenin şu alanlarını doldurun:
   - `localAsset: 'other/<dosya-adi>.pdf'`
   - `pdfAvailable: true`
