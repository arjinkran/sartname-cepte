// EPDK arama adaptörü (Sprint 12, madde 7).
...
const PROVIDER_ID = 'epdk';

export const epdkAdapter: ProviderSearchAdapter = {
  providerId: PROVIDER_ID,

  canSearch(document: Document): boolean {
    return document.institution === 'EPDK';
  },
  ...
  buildSearchRequests(document: Document): readonly NetworkSearchRequest[] {
    ...
    return [{ documentId: document.id, providerId: PROVIDER_ID, url: target, method: 'GET', reason: 'EPDK resmî sayfa taraması' }];
  },
