// TEDAŞ arama adaptörü (Sprint 12, madde 7).
...
const PROVIDER_ID = 'tedas';

export const tedasAdapter: ProviderSearchAdapter = {
  providerId: PROVIDER_ID,

  canSearch(document: Document): boolean {
    return document.institution === 'TEDAŞ';
  },
  ...
  buildSearchRequests(document: Document): readonly NetworkSearchRequest[] {
    ...
    // Strateji 1 (madde 8): belgenin kendi sourceUrl'i resmî domainden ise
    // doğrudan onu kontrol et. Aksi hâlde kurumun bilinen ana sayfasını tara.
    ...
    return [{ documentId: document.id, providerId: PROVIDER_ID, url: target, method: 'GET', reason: 'TEDAŞ resmî sayfa taraması' }];
  },
